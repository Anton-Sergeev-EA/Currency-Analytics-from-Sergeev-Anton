...
(crontab -l 2>/dev/null; echo "30 10 * * * curl -X POST -H \"X-Admin-Key: $ADMIN_KEY\" http://127.0.0.1:8000/api/refresh"; echo "0 16 * * * curl -X POST -H \"X-Admin-Key: $ADMIN_KEY\" http://127.0.0.1:8000/api/refresh") | crontab -
