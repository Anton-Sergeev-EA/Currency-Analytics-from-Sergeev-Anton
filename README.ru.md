...
- Исторические курсы валют из API ЦБ РФ (USD/RUB, EUR/RUB, CNY/RUB, GBP/RUB), с резервным
...
| GET | `/api/forecast/forecast?days=N&currency=USD\|EUR\|CNY\|GBP\|ALL` | ML-прогноз на 1-30 дней. |
